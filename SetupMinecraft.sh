...
# curl https://raw.githubusercontent.com/DracoDominus/MinecraftBedrockServer/master/SetupMinecraft.sh | bash
#
# GitHub Repository: https://github.com/DracoDominus/MinecraftBedrockServer

echo "Minecraft Bedrock Server installation script by James A. Chambers"
echo "Latest version always at https://github.com/DracoDominus/MinecraftBedrockServer"
...
Update_Scripts() {
  ...
  curl -H "Accept-Encoding: identity" -L -o start.sh https://raw.githubusercontent.com/DracoDominus/MinecraftBedrockServer/master/start.sh
  chmod +x start.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o stop.sh https://raw.githubusercontent.com/DracoDominus/MinecraftBedrockServer/master/stop.sh
  chmod +x stop.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o restart.sh https://raw.githubusercontent.com/DracoDominus/MinecraftBedrockServer/master/restart.sh
  chmod +x restart.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o fixpermissions.sh https://raw.githubusercontent.com/DracoDominus/MinecraftBedrockServer/master/fixpermissions.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o revert.sh https://raw.githubusercontent.com/DracoDominus/MinecraftBedrockServer/master/revert.sh
  chmod +x revert.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o clean.sh https://raw.githubusercontent.com/DracoDominus/MinecraftBedrockServer/master/clean.sh
  chmod +x clean.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o update.sh https://raw.githubusercontent.com/DracoDominus/MinecraftBedrockServer/master/update.sh
  chmod +x update.sh
...
Update_Service() {
  ...
  sudo curl -H "Accept-Encoding: identity" -L -o /etc/systemd/system/$ServerName.service https://raw.githubusercontent.com/DracoDominus/MinecraftBedrockServer/master/minecraftbe.service
  ...
  if command -v apt-get &>/dev/null; then
    ...
    if [[ "$SSLVer" ]]; then
      ...
      if [[ "$CPUArch" == *"x86_64"* ]]; then
        ...
        sudo curl -o libssl.deb -k -L https://github.com/DracoDominus/Legendary-Bedrock-Container/raw/main/libssl1-1.deb
...
Check_Architecture() {
  ...
  if [[ "$CPUArch" == *"aarch"* ]]; then
    ...
    curl -H "Accept-Encoding: identity" -L -o depends.zip https://raw.githubusercontent.com/DracoDominus/MinecraftBedrockServer/master/depends.zip
    unzip depends.zip
    sudo mkdir /lib64
